...
class MedicalDocParser:
    ...
    def parse_document(
            ...
            do_picture_desc: bool=False )->Tuple[Any,List[str]]:
        """
        ...
        pipeline_options=PdfPipelineOptions(
            ...
            image_resolution=image_resolution_scale,
            dp_ocr=do_ocr,
        ...
        for element,_level in conversion_res.document.iterate_items():
            ...
            if isinstance(element,PictureItem):
                picture_counter+=1
                picture_path=output_dir_path/f"{doc_filename}-picture-{picture_counter}.png"
                with picture_path.open("wb") as fp:
                    element.get_image(conversion_res.document).save(fp,"PNG")
            
                image_paths.append(str(picture_path))
