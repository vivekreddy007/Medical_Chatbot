...
class VectorStore:
    ...
    def __init__(self,config):
        ...
        #connects the local path with Qdrant or Creates it and connects if path doesnt exists.
    ...
    def _create_collection(self):
        ...
        try:
            ...
            self.logger.error(f"Error creating Vector Collection {e}")
            raise e
    ...
    def create_vectorstore(self,document_chunks:List[str],document_path:str)->Tuple[QdrantVectorStore,LocalFileStore,List[str]]:
        """
        ...
        #check is collection exists,create if its doesn't
